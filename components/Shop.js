...
export default function ShopSection() {
  const products = [
    { id: '1', name: 'Syltherine', price: 'Rp 2.500.000', img: '/images/p1.jpeg' },
    { id: '2', name: 'Leviosa', price: 'Rp 2.500.000', img: '/images/p2.png' },
    { id: '3', name: 'Lolito', price: 'Rp 7.000.000', img: '/images/p3.png' },
    { id: '4', name: 'Respira', price: 'Rp 500.000', img: '/images/p4.png' },
    ...
    <section className="bg-gray-50 min-h-screen flex items-center">
      <div className="container mx-auto px-4 flex flex-col items-center">
        <div className="text-center mb-8 bg-[#FFF3E3] h-80 w-full flex flex-col items-center justify-center">
          ...
          <p className="text-gray-500 mt-2"><span className='font-bold'>Home</span>/ Shop</p>
